...
*/
	...
	define('QA_VERSION', '1.6-dev-0203'); // also used as suffix for .js and .css requests
	define('QA_BUILD_DATE', '2013-02-03');
...
*/
	{
		...
		if (!defined('QA_BASE_DIR'))
			...
			define('QA_BASE_DIR','/'); // try out best if not set in index.php or qa-index.php - won't work with symbolic links
